        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <select className="form-control" value={form.course_id}
              onChange={e => setForm((f: any) => ({ ...f, course_id: e.target.value }))} required>
          ...
          <div className="form-grid">
            <div className="form-group"><label className="form-label">Order #</label>
              <input type="number" className="form-control" value={form.order_number} onChange={set('order_number')} />
            </div>
          ...
          <div className="form-group"><label className="form-label">Replace Thumbnail (optional)</label>
            <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
              ...
              <input type="file" ref={thumbRef} accept="image/*" className="form-control"
